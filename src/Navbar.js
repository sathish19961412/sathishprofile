...
import './index.css';
import pdf from './assets/pdf/sathish.pdf'
export default function Navbar(){
    ...
    return(
        ...
        <Element name='home' className="navbar-brand font-weight-bold cssanimation typing"  data-aos="zoom-out" data-aos-easing="linear" data-aos-duration="500" data-aos-once="true">Sathish</Element>
