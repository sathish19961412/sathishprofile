...
export default function Navbar(){
    return(
        ...
        <Element name='home' className="navbar-brand text-white font-weight-bold cssanimation typing"  data-aos="zoom-out" data-aos-easing="linear" data-aos-duration="500" data-aos-once="true">Sathish Protfolio</Element>
